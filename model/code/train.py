...
tf.app.flags.DEFINE_integer("question_output_size", 30, "The output size of question.")
tf.app.flags.DEFINE_integer("paragraph_output_size", 400, "The output size of paragraph.")
